...
**Ključno pravilo:**
- **Svaki unavailabilityReason ima vlastite evidencije promjena i stanje**
- Stanje se računa PO unavailabilityReason-u (ne sumira se sveukupno)
- Zaposlenik ima odvojena stanja za "Godišnji odmor", "Slobodni dani", "Edukacija", itd.
- Stanja različitih unavailabilityReason-a se NE zbrajaju i NE miješaju
...
model UnavailabilityLedgerEntry {
  ...
  organisationId         Int
  employeeId             Int
  unavailabilityReasonId Int                  // Identificira TIP
  year                   Int           // 2024, 2025...
...
**Primjer evidencija promjena - ODVOJENO po unavailabilityReason-u:**
```
Employee ID: 123, Year: 2025

--- Godišnji odmor (unavailabilityReasonId = 1) ---
ALLOCATION   | +20  | "Godišnja dodjela"
...
ALLOCATION   | +5   | "Dodjela slobodnih dana"
...
**Kalkulacija stanja za SPECIFIČNI unavailabilityReason:**
```typescript
