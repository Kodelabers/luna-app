...
export function MemberSearchBar() {
  ...
  const hasFilters = currentSearch || currentSort !== "asc" || currentRole;
  ...
  const formKey = `${currentSearch}-${currentSort}-${currentRole}`;
